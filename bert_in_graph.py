...
class BertModel(object):
  ...
  """
    ...
    """
        ...
        config.hidden_dropout_prob = 1-self.dropout
        config.attention_probs_dropout_prob = 1-self.dropout
        ...
        with tf.variable_scope(scope, default_name="bert"):
            with tf.variable_scope("embeddings"):
                ...
                # self.pt = config.hidden_dropout_prob#self.embedding_output
    ...
    """
        ...
        # saver=tf.contrib.framework.get_variables_to_restore(）
